...
function Quality() {
    ...
    return (
        <Section id='quality' classes='background-colored-logo' observe={true}>
            <Row classes='pt-20 pb-20 lg:pb-32'>
                ...
                <ul className='bg-neutral-400/60 text-center text-xl flex flex-col gap-4 py-8 px-4 font-bold max-w-[100%] md:max-w-[60%] mx-auto relative'>
                    ...
                    <Image
                        ...
                        width={315}
                        height={307}
                        className=' absolute bottom-0 left-0 translate-y-24 -translate-x-72 hidden lg:block'
                    />
                    <Image
